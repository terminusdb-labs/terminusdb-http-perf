...
export default function (cfg) {
  ...
  k6.sleep(1)
  api.documentCreateSchema(cfg, __ITER, schemaOne, { api: 'one' })
  k6.sleep(1)
  api.dbDelete(cfg, __ITER)
  k6.sleep(1)
  api.dbCreateWithPrefixes(cfg, __ITER)
  k6.sleep(1)
  api.documentCreateSchema(cfg, __ITER, schemaPerson, { api: 'person' })
  k6.sleep(1)
  api.dbDelete(cfg, __ITER)
  k6.sleep(1)
  api.dbCreateWithPrefixes(cfg, __ITER)
  k6.sleep(1)
  api.documentCreateSchema(cfg, __ITER, schemaWoql, { api: 'woql' })
  k6.sleep(1)
  api.dbDelete(cfg, __ITER)
  k6.sleep(1)
}
